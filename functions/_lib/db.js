  ...
  await db.batch([
    db
      .prepare(
        `
          INSERT INTO reservations (
            ...
            guest_mobile_phone, guest_address_street, guest_address_zip, guest_address_city, guest_address_country,
            guest_date_of_birth, guest_nationality, guest_id_document_number,
      ...
      .bind(
        ...
        reservation.guestMobilePhone || null,
        reservation.guestAddressStreet || null,
        reservation.guestAddressZip || null,
        reservation.guestAddressCity || null,
        reservation.guestAddressCountry || null,
        reservation.guestDateOfBirth || null,
        reservation.guestNationality || null,
        reservation.guestIdDocumentNumber || null,
        JSON.stringify(reservation.additionalGuests || []),
  ...
  await db.batch([
    db
      ...
      .bind(
        ...
        updates.guestFirstName || null,
        updates.guestLastName || null,
        updates.guestPhone || null,
        updates.guestMobilePhone || null,
        updates.guestAddressStreet || null,
        updates.guestAddressZip || null,
        updates.guestAddressCity || null,
        updates.guestAddressCountry || null,
        updates.guestDateOfBirth || null,
        updates.guestNationality || null,
        updates.guestIdDocumentNumber || null,
        JSON.stringify(updates.additionalGuests || []),
...
export async function getDepartureReservationsForDate(env, isoDate) {
  const db = requireDb(env);
  const { results } = await db
    .prepare(
      `
        ...
        WHERE reservations.check_out_date = ?
          AND reservations.status IN ('confirmed', 'modified', 'refund_due', 'pending_refund')
          AND reservations.unit_type = 'studio'
